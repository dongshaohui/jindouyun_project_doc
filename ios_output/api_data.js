define({ "api": [
  {
    "type": "get",
    "url": "/user_serv/dish/search_dishes_v2",
    "title": "菜品搜索接口",
    "name": "______1",
    "group": "Dish_Module",
    "version": "0.1.1",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "float",
            "optional": false,
            "field": "dish_info_list.dish_order_checkout_thres",
            "description": "<p>菜品成菜价格下限（只对含配菜有效）</p>"
          },
          {
            "group": "Success 200",
            "type": "float",
            "optional": false,
            "field": "dish_info_list.dish_order_types_checkout_thres",
            "description": "<p>菜品成菜配菜种类下限（只对含配菜有效）</p>"
          },
          {
            "group": "Success 200",
            "type": "int",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "float",
            "optional": false,
            "field": "dish_order_checkout_thres",
            "description": "<p>菜品成菜下限（只对含配菜菜品有效）</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
  ...
  {
    "type": "get",
    "url": "/user_serv/dish/get_all_dish_category",
    "title": "获取某家店所有菜品大类接口",
    "name": "_____________1",
    "group": "Dish_Module",
    "version": "0.1.0",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "object[]",
            "optional": false,
            "field": "dish_category_info",
            "description": "<p>某家店所有菜品大类数组</p>"
          },
          {
            "group": "Success 200",
            "type": "int",
            "optional": false,
            "field": "dish_category_info.dish_category_id",
          ...
          },
          {
            ...
            "type": "int",
            "optional": false,
            "field": "dish_category_info.dish_category_name",
            "description": "<p>菜品大类名称</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "get",
    "url": "/user_serv/dish/get_category_all_dishes",
    "title": "获取某菜品大类下所有菜品信息接口",
    "name": "________________1",
    "group": "Dish_Module",
    "version": "0.1.1",
    "description": "<p>接口详细描述</p>",
    "parameter": {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "int",
            "optional": false,
            "field": "dish_info.current_month_order",
            "description": "<p>菜品当月订单数</p>"
          },
          {
            "group": "Success 200",
            "type": "float",
            "optional": false,
            "field": "dish_info.dish_order_checkout_thres",
            "description": "<p>菜品成菜价格下限（只对含配菜有效）</p>"
          },
          {
            "group": "Success 200",
            "type": "float",
            "optional": false,
            "field": "dish_info.dish_order_types_checkout_thres",
            "description": "<p>菜品成菜配菜种类下限（只对含配菜有效）</p>"
          },
          {
            "group": "Success 200",
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "-1",
            "description": "<p>dish_category_id无效</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "get",
    "url": "/user_serv/dish/get_all_dish_property",
    "title": "获取菜品的属性列表（只对含配菜有效）",
    "name": "__________________1",
    "group": "Dish_Module",
    "version": "0.1.1",
    "description": "<p>接口详细描述</p>",
    "parameter": {
        ...
        "Success 200": [
          {
            ...
            "type": "object[]",
            "optional": false,
            "field": "dish_property_info",
            "description": "<p>菜品的属性列表</p>"
          },
          {
            "group": "Success 200",
            "type": "int",
            "optional": false,
            "field": "dish_property_info.dish_property_group_id",
            "description": "<p>菜品属性组别ID</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "dish_property_info.dish_property_group_desc",
            "description": "<p>菜品属性组别描述</p>"
          },
          {
            "group": "Success 200",
            "type": "object[]",
            "optional": false,
            "field": "dish_property_info.dish_property_list",
            "description": "<p>该属性组别下属性列表</p>"
          },
          {
            "group": "Success 200",
            "type": "int",
            "optional": false,
            "field": "dish_property_info.dish_property_list.dish_property_id",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "dish_property_info.dish_property_list.dish_property_desc",
  ...
  {
    "type": "get",
    "url": "/user_serv/get_all_district_info",
    "title": "获取所有分区接口",
    "name": "________",
    "group": "District_Module",
    "version": "0.1.1",
    "description": "<p>接口详细描述</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "district_list",
            "description": "<p>分区信息列表</p>"
          },
          {
            "group": "Success 200",
            "type": "int",
            "optional": false,
            "field": "district_list.district_id",
          ...
          },
          {
            ...
            "type": "float",
            "optional": false,
            "field": "district_list.district_name",
            "description": "<p>分区名称</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "float",
            "optional": false,
            "field": "order_list.discount_rate",
            "description": "<p>折扣率</p>"
          },
          {
            "group": "Success 200",
            "type": "float",
            "optional": false,
            "field": "order_list.dish_price",
            "description": "<p>菜品总价</p>"
          },
          {
            "group": "Success 200",
            "type": "float",
            "optional": false,
            "field": "order_list.payable_price",
            "description": "<p>应付价格</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
  ...
  {
    "type": "get",
    "url": "/user_serv/shop/get_shop_all_pay_types",
    "title": "获取店铺内支持支付方式接口",
  ...
  {
    "type": "post",
    "url": "/user_serv/address/add_delivery_address_v2",
    "title": "新增收货地址",
    "name": "______1",
  ...
  {
    "type": "get",
    "url": "/user_serv/add_delivery_address",
    "title": "新增收货地址",
    "name": "______1",
    "group": "User_Address_Module",
    "version": "0.1.0",
  ...
  {
    "type": "POST",
    "url": "/user_serv/pay/add_credit_card_v2",
    "title": "新增信用卡接口",
    "name": "_______1",
    "group": "User_Pay_Type_Module",
    "version": "0.1.1",
  ...
  {
    "type": "get",
    "url": "/user_serv/pay/paytype_infos_v2",
    "title": "获取用户支付管理信息",
    "name": "__________1",
    "group": "User_Pay_Type_Module",
    "version": "0.1.2",
